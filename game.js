...
if(Math.random()<0.02){
obstacles.push({x:canvas.width,y:310,width:30,height:30});
}
if(Math.random()<0.01){
coins.push({x:canvas.width,y:260,size:10});
}
}
